...
Traceback (most recent call last):
  ...
  File "/Users/adrianlyjak/dev/onnx/.venv/lib/python3.12/site-packages/torch/onnx/_internal/exporter/_capture_strategies.py", line 197, in _capture
    raise exc from None
  ...
  File "/Users/adrianlyjak/dev/onnx/.venv/lib/python3.12/site-packages/torch/export/dynamic_shapes.py", line 788, in _check_dynamic_shapes
  ...
  File "/Users/adrianlyjak/dev/onnx/.venv/lib/python3.12/site-packages/torch/utils/_pytree.py", line 1635, in tree_map_with_path
    return treespec.unflatten(func(*xs) for xs in zip(*all_keypath_leaves))
           ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

  File "/Users/adrianlyjak/dev/onnx/.venv/lib/python3.12/site-packages/torch/utils/_pytree.py", line 830, in unflatten
    leaves = list(leaves)
             ^^^^^^^^^^^^

  File "/Users/adrianlyjak/dev/onnx/.venv/lib/python3.12/site-packages/torch/utils/_pytree.py", line 1635, in <genexpr>
    return treespec.unflatten(func(*xs) for xs in zip(*all_keypath_leaves))
                              ^^^^^^^^^

  File "/Users/adrianlyjak/dev/onnx/.venv/lib/python3.12/site-packages/torch/export/dynamic_shapes.py", line 501, in f
    return func(path, t, *dynamic_shapes)
           ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

  File "/Users/adrianlyjak/dev/onnx/.venv/lib/python3.12/site-packages/torch/export/dynamic_shapes.py", line 777, in check_shape
    check_symbols(path, t, dynamic_shape)

  File "/Users/adrianlyjak/dev/onnx/.venv/lib/python3.12/site-packages/torch/export/dynamic_shapes.py", line 715, in check_symbols
    raise UserError(

torch._dynamo.exc.UserError: Unexpected dimension mapped to index 0 in input tensor shape {0: 'batch_size', 1: 'sequence_length'} specified at `dynamic_shapes['phonemes']` (expected None, an int, a Dim, Dim.AUTO, Dim.STATIC, or Dim.DYNAMIC,  but got batch_size instead)
...
Traceback (most recent call last):
  ...
  File "/Users/adrianlyjak/dev/onnx/.venv/lib/python3.12/site-packages/torch/onnx/_internal/exporter/_capture_strategies.py", line 156, in _capture
    raise exc from None
...
```
  ...
  _     ._   __/__   _ _  _  _ _/_   Recorded: 17:52:29  Samples:  3092
 /_//_/// /_\ / //_// / //_'/ //     Duration: 3.851     CPU time: 8.971
/   _/                      v5.0.1

Profile at /Users/adrianlyjak/dev/onnx/.venv/lib/python3.12/site-packages/torch/onnx/_internal/exporter/_core.py:811

3.850 export  torch/onnx/_internal/exporter/_core.py:1167
└─ 3.850 JitTraceConvertStrategy.__call__  torch/onnx/_internal/exporter/_capture_strategies.py:99
      [460 frames hidden]  torch, <string>, kokoro, <built-in>, ...
         0.076 <lambda>  torch/_dynamo/utils.py:2028
         └─ 0.076 deepcopy  copy.py:118
            └─ 0.076 _reconstruct  copy.py:247
               └─ 0.076 deepcopy  copy.py:118
                  └─ 0.076 _deepcopy_dict  copy.py:217
                     └─ 0.076 deepcopy  copy.py:118
                        └─ 0.068 _deepcopy_dict  copy.py:217
                           └─ 0.068 deepcopy  copy.py:118
                              └─ 0.068 Parameter.__deepcopy__  torch/nn/parameter.py:63
                                    [4 frames hidden]  torch
         0.108 _add_file  torch/_dynamo/funcname_cache.py:12
         └─ 0.101 _generate_tokens_from_c_tokenizer  tokenize.py:569
            └─ 0.086 TokenInfo._make  collections/__init__.py:447
